...
public class Magpie3{
    ...
    public String getResponse(String statement){
        ...
        }else if(findKeyword(statement, "Hello darkness my old friend.") >= 0){
        ...
        }else if (findKeyword(statement, "catcher") >= 0 
        || findKeyword(statement, "pitcher") >= 0 
        || findKeyword(statement, "first") >= 0 
        || findKeyword(statement, "second") >= 0 
        || findKeyword(statement, "third") >= 0 
        || findKeyword(statement, "short") >= 0 
        || findKeyword(statement, "left") >= 0 
        || findKeyword(statement, "center") >= 0 
        || findKeyword(statement, "right") >= 0){
    ...
    /**
     * Search for one word in phrase. The search is not case sensitive. This method will check that the given goal is not a substring of a longer string (so, for example, "I know" 
     * does not contain "no"). The search begins at the beginning of the string.
     * 
     * @param statement
     *            the string to search
     * @param goal
